<template>
  <v-container id="extended-tables"
    ...
    <users-data     :currentUser="currentUser"
                    :usersData="usersData"
                    :userData="userData"
                    :addUser="addUser"
    ...
    <saved-data     :filters="filters"
                    ...
                    :buttonOneIsPressed="buttonOneIsPressed"
                    :toDivide="toDivide"
...
<script>
    ...
    export default {
      ...
      components: {
        ...
        SavedData: () =>  import('../components/core/SavedData'),
        UsersData: () =>  import('../components/core/UsersData'),
      },
      ...
      methods: {
        sortTable(column,indexData,type,indexIn,dataType,filterValues){
          ...
          if (type === 'pivot') {
            ...
            if(dataType == 'savedData'){
              unordered = this.savedData.comparative_table_result[indexData].data;
            } else {
          ...
          if (type === 'pivot') {
            if(dataType == 'savedData'){
              this.savedData.pivot_table_result[indexData].data = ordered;
            } else {
              this.pivot_table_results[indexData].pivot_table_result.data = ordered;
            }
          } else {
            if(dataType == 'savedData') {
              this.savedData.comparative_table_result[indexData].data = ordered;
            } else {
